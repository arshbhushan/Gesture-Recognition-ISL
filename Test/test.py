...
labels =  ["Hello", "Happy", "Apple","Ball","Behind","Cat","Come", "Dog", "Doctor","Danger", "Ear", "Eating", "Earing", "Eggs", "Frog", "Fancy", "Food", "Good", "Grapes", "Going", "Icecream", "Joke", "Jogging" ,"know", "knowledge", "last"]
